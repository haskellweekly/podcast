...
episodes =
  [ Episode.Episode
    <$> Description.fromString "Sara Lichtenstein and Taylor Fausak talk about upgrading from Elm 0.18 to 0.19. https://engineering.itpro.tv/2019/03/01/upgrading-elm-to-v19/"
  ...
  , Episode.Episode
    <$> Description.fromString "Cody Goodman and Taylor Fausak talk about handling exceptions in Haskell. https://markkarpov.com/tutorial/exceptions.html"
